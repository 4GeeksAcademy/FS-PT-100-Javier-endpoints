...
class User(db.Model):
    ...
    def serialize(self):
        return {
            "id": self.id,
            "email": self.email,
            #serializamos el perfil porque recibimos un objeto de la tabla Perfiles que es el perfil asociado al usuario
            #los objetos no son compatibles con JSONIFY, solo los diccionarios
